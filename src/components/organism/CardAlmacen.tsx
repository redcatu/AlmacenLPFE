          ...
          <div className="row mb-3">
            ...
            <div className="col-md-6">
              <p className="mb-2 dashboard-info">
                ...
                {almacen.capacidadMaxima.toLocaleString()}
              </p>
              <p className="mb-2 dashboard-info">
                <strong>Cantidad Disponible:</strong>{" "}
                {almacen.cantidadDisponible.toLocaleString()}
              </p>
            </div>
          </div>
          ...
          <div className="mb-3">
            <div className="d-flex justify-content-between mb-2">
              <span className="dashboard-label">
                <strong>Ocupación del Almacén</strong>
              </span>
          ...
          <div className="row text-center mt-4">
            <div className="col-md-4">
              <div className="dashboard-summary-card">
                <h5 className="dashboard-summary-number dashboard-purple">
                  {almacen.capacidadMaxima.toLocaleString()}
                </h5>
                <small className="dashboard-summary-label">
                  Capacidad Total
                </small>
              </div>
            </div>
            <div className="col-md-4">
              <div className="dashboard-summary-card">
                <h5 className="dashboard-summary-number dashboard-green">
                  {espacioOcupado.toLocaleString()}
                </h5>
            ...
            <div className="col-md-4">
              <div className="dashboard-summary-card">
                <h5 className="dashboard-summary-number dashboard-purple-light">
                  {espacioDisponible.toLocaleString()}
                </h5>
